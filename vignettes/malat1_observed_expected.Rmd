...
l1 <- readMM('/rafalab/lzou/rdsprite/dna_matrix/Malat1_DNA_matrix_count_RNA_100000_clusters_2-100.mtx')
...
rna_offset <- fread('/rafalab/lzou/rdsprite/total_RNA_count_windows_100000_clusters_2-100.csv') |>
  filter(chrom==chro) |>
  select(-V1)
total_l1_rna <- fread('/rafalab/lzou/rdsprite/count_windows/Malat1_RNA_count_windows_100000_clusters_2-100.csv') |>
  filter(chrom==chro)
...
save(before, after, file = paste0('malat1_decon_',chro,'.RData'))
```
