...
l1 <- readMM(paste0('/rafalab/lzou/rdsprite/dna_matrix/',params$mol,'_DNA_matrix_count_RNA_100000_clusters_2-100.mtx'))
...
rna_offset <- fread('/rafalab/lzou/rdsprite/total_RNA_count_windows_100000_clusters_2-100.csv') |>
  filter(chrom==chro) |>
  select(-V1)
total_l1_rna <- fread(paste0('/rafalab/lzou/rdsprite/count_windows/',params$mol,'_RNA_count_windows_100000_clusters_2-100.csv')) |>
  filter(chrom==chro)
...
save(before, after, file = paste0(params$mol,'_decon_',chro,'.RData'))
```
